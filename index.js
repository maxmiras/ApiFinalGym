...
app.post('/obtenerContrasena', async (req, res) => {
...
app.post('/iniciarSecion', async (req, res) => {
    console.log(req.body)
...
app.post('/eliminarEntrenamiento',async (req,res)=>{
    if(req.body.id){
        try {
...
app.post('/obtHisEnt', async (req, res) => {
    console.log(req.body)
    if (req.body.DNI) {
        try {
...
app.post('/addEntrenamiento', async (req, res) => {
    // console.log(req.body)
